...
const Signup = () => {
  ...
  // Helper to fetch and set profile image after login
  ...
  // --- NEW: Combined Signup/Login Handler ---
  const handleSignupOrLogin = async () => {
    ...
    let walletAddress = '';
    let loginType: 'metamask' | 'google' | 'walletConnect' = 'metamask';
    if (isConnected) {
          ...
          <CardContent>
            <form className="space-y-4 pt-4">
              ...
              <Button
                type="button"
                onClick={
                  isConnected || wcIsConnected ? handleSignupOrLogin : sendToast
                }
