...
<div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
  <div className="flex justify-between items-center h-16">
    ...
    <div className="flex space-x-2 items-center">
      <Button onClick={handleMongoConnect} variant="outline" size="sm">
        Connect MongoDB
      </Button>
      {mongoStatus && (
    ...
    <div className="mr-4">
      ...
      <div className="flex items-center space-x-4">
        {isConnected && address ? (
          <DropdownMenu>
            <Link to={`/profile`}>  
            <button className="block text-left w-full px-4 py-2 text-black hover:bg-[#00BFFF] dark:hover:text-white dark:text-white" onClick={handleProfile}>
              Manage Profile
            </button>
            </Link>
