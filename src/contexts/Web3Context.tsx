...
export const Web3Provider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <Web3Context.Provider value={{ address, isConnected: !!isConnected, connectWallet, disconnectWallet: () => setShowDisconnectConfirm(true) }}>
      {children}
      {showDisconnectConfirm && (
          <div className="fixed inset-0 z-100 flex items-center justify-center bg-black bg-opacity-40">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg w-80">
              <h2 className="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-100">Are you sure?</h2>
              <p className="mb-6 text-gray-600 dark:text-gray-300">Do you really want to disconnect your wallet?</p>
