...
const Dashboard = () => {
  ...
  // Add this state near the top of your Dashboard component
  ...
  const uploadFile = async () => {
    ...
    try {
      ...
      // Use the browser's File constructor with options if available, fallback to Blob if not
      let encryptedFile;
      try {
            ...
            <div className="lg:col-span-2">
              ...
              >
                ...
                <CardContent className="space-y-4">
                  ...
                  {/* Encryption options - only for encrypted files */}
                  {file && (
                    <div className="mt-4">
                          ...
                          onClick={() => {
                            ...
                            setTimeout(() => {
                              ...
                              toast({
                                ...
                                description: 'Your file has been encrypted.',
                                className:
                                  'font-["Century_Gothic",CenturyGothic,AppleGothic,sans-serif] tracking-wider',
                              });
                            }, 2000);
                  ...
                  {/* Success message - show only after successful upload */}
                  {uploadSuccess && (
                    <div className="mt-4 text-green-500">
                      <CheckIcon className="inline-block mr-1" />
                ...
                <CardContent>
                  {!previewFile ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between mt-6 border-t pt-4 border-dashed border-gray-300 dark:border-gray-700">
                        ...
                        <Button
                          ...
                          className="flex items-center text-[#00BFFF]"
                        >
                          {uploadLoading ? (
