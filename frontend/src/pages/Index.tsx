    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          >
            The future of decentralized storage. Store, access, and manage your
            files on the InterPlanetary File System with blockchain security.
          </p>
      ...
      {!isAuthenticated && (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          >
            ...
            >
              Join thousands of users who trust StorageX for their decentralized
              storage needs
            </p>
            <Link to="/signup">
              <Button
